...
with col_a:
    ...
    ax1.set_title("Delivery Status Distribution", fontsize=11, fontweight="bold")
    st.pyplot(fig1, use_container_width=True)

with col_b:
    st.subheader("🚦 Avg Delivery Time by Traffic Level")
    traffic_avg = (
    ...
    ax2.set_xlabel("Traffic Level", fontsize=10)
    ax2.set_ylabel("Avg Delivery Time (min)", fontsize=10)
    ax2.set_title("Average Delivery Time by Traffic Level", fontsize=11, fontweight="bold")
...
# ── Row 2: Chart 3 + Chart 4 side by side ────────────────────────────────────
...
with col_c:
    ...
    ax3.set_xlabel("Delay Rate (%)", fontsize=10)
    ax3.set_title("Delay Rate by Vehicle Type", fontsize=11, fontweight="bold")
...
with col_d:
    ...
    ax4.set_xlabel("Avg Delivery Time (min)", fontsize=10)
    ax4.set_title("Average Delivery Time by Area Type", fontsize=11, fontweight="bold")
    ax4.spines["top"].set_visible(False); ax4.spines["right"].set_visible(False)
    for i, val in enumerate(area_avg["Delivery_Time"]):
        ax4.text(val+0.3, i, f"{val:.1f} min", va="center", fontweight="bold", fontsize=9)
